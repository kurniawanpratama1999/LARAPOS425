<div id="add-modal-user"
    ...
    <div class="relative  p-3 w-full max-w-[450px] bg-neutral-100 shadow">
        <div>
            ...
            <p class="text-xs text-yellow-700 mt-2 p-2 bg-yellow-400/10 outline outline-yellow-500">Kamu ada di mode
                tambah user, pastikan Email dan Password dimasukan dengan benar.</p>
        </div>
        <form id="users-store" class="mt-5 grid grid-cols-2 gap-5">
            ...
            <div class="col-span-2 flex flex-row gap-2 mt-5 w-fit ml-auto font-bold">
                ...
                <button id="add-modal-user" type="submit"
                    class="disabled:bg-neutral-500 px-3 cursor-pointer py-1 rounded-md bg-emerald-300 text-white">Add
                    User</button>
            </div>
        </form>
    </div>
